    ...
    public function create()
{
    ...
    if (!Auth::check()) { // Jika menggunakan guard 'web', pakai Auth::check() secara langsung
        return redirect()->route('login')->with('error', 'Anda harus login terlebih dahulu.');
    }

    // Ambil data pengguna dari tabel users
    $user = Auth::user(); // Ambil data pengguna yang sedang login dari tabel users

    // Gunakan data nis dari tabel users, jika data tersebut ada
    $nis = $user->nis; // Ambil NIS dari data pengguna yang terautentikasi
    ...
    // Ambil data lokasi absen dari tabel konfigurasi_lokasi
